...
<p class="intro"><span class="dropcap">X</span>codeBuild MCP is a Model Context Protocol (MCP) server I created to connect AI agents with Xcode projects. I wanted a standardised interface for programmatic interactions that would make my own development workflow smoother.</p>
